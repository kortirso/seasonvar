RSpec.describe 'UserToken API' do
  describe 'POST#create' do
    context 'without params' do
      before { post '/api/v1/user_token.json', params: {} }
    ...
    context 'for email params' do
      context 'for invalid params' do
        before { post '/api/v1/user_token.json', params: { email: '1@gmail.com', password: '1234567890' } }
      ...
      context 'for valid params' do
        ...
        before { post '/api/v1/user_token.json', params: { email: user.email, password: user.password } }
        ...
        %w[token expires_at].each do |attr|
